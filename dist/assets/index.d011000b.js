...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function wh(){return new nr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vf(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function Eh(){return new nr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vf(),fragmentShader:`
...
#define LOW_PRECISION`),e}function pM(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===ng?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===i_?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===As&&(e="SHADOWMAP_TYPE_VSM"),e}function mM(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case is:case rs:e="ENVMAP_TYPE_CUBE";break;case tl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function gM(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case rs:e="ENVMAP_MODE_REFRACTION";break}return e}function vM(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case sg:e="ENVMAP_BLENDING_MULTIPLY";break;case E_:e="ENVMAP_BLENDING_MIX";break;case T_:e="ENVMAP_BLENDING_ADD";break}return e}function _M(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function xM(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=pM(t),u=mM(t),c=gM(t),d=vM(t),f=_M(t),g=t.isWebGL2?"":oM(t),_=aM(s),p=r.createProgram();let h,m,v=t.glslVersion?"#version "+t.glslVersion+`
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var nw=ro.exports,iw=Symbol.for("react.element"),rw=Symbol.for("react.fragment"),sw=Object.prototype.hasOwnProperty,ow=nw.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,aw={key:!0,ref:!0,__self:!0,__source:!0};function Lg(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)sw.call(e,i)&&!aw.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:iw,type:n,key:s,ref:o,props:r,_owner:ow.current}}rl.Fragment=rw;rl.jsx=Lg;rl.jsxs=Lg;(function(n){n.exports=rl})(Ag);const Ua=Ag.exports.jsx;function lw(){return ro.exports.useEffect(()=>{const n=new YM,e=new Gt(50,window.innerWidth/window.innerHeight,1,1e3);e.position.z=96;const t=document.getElementById("myThreeJsCanvas"),i=new Cg({canvas:t,antialias:!0});i.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(i.domElement);const r=new JM(16761035,.5);r.castShadow=!0,n.add(r);const s=new QM(16777215,1);s.castShadow=!0,s.position.set(0,64,32),n.add(s);const o=new tr(30,15,10),a=new $M,l=new Hn(o,a);n.add(l);const u=new tw(e,i.domElement),c=new ew,d=new Me;function f(p){d.x=p.clientX/window.innerWidth*2-1,d.y=-(p.clientY/window.innerHeight)*2+1}function g(){c.setFromCamera(d,e);for(var p=c.intersectObject(tr),h=0;h<p.length;h++){var m=p[h].faceIndex;m==0||m%2==0?(p[h].object.geometry.faces[m].color.setHex(13743027),p[h].object.geometry.faces[m+1].color.setHex(13743027),p[h].object.geometry.colorsNeedUpdate=!0):(p[h].object.geometry.faces[m].color.setHex(13743027),p[h].object.geometry.faces[m-1].color.setHex(13743027),p[h].object.geometry.colorsNeedUpdate=!0)}i.render(n,e)}window.addEventListener("pointermove",f),window.requestAnimationFrame(g);const _=()=>{u.update(),i.render(n,e),window.requestAnimationFrame(_)};_()},[]),Ua("div",{children:Ua("canvas",{id:"myThreeJsCanvas"})})}pu.createRoot(document.getElementById("root")).render(Ua(Qg.StrictMode,{children:Ua(lw,{})}));
