const zg=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerpolicy&&(s.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?s.credentials="include":r.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}};zg();function kg(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var io={exports:{}},Ae={};/**
 * @license React
 ...
 */var ro=Symbol.for("react.element"),Og=Symbol.for("react.portal"),Ug=Symbol.for("react.fragment"),Bg=Symbol.for("react.strict_mode"),Vg=Symbol.for("react.profiler"),Gg=Symbol.for("react.provider"),Hg=Symbol.for("react.context"),Wg=Symbol.for("react.forward_ref"),jg=Symbol.for("react.suspense"),Xg=Symbol.for("react.memo"),qg=Symbol.for("react.lazy"),Sf=Symbol.iterator;function Yg(n){return n===null||typeof n!="object"?null:(n=Sf&&n[Sf]||n["@@iterator"],typeof n=="function"?n:null)}var Yh={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},$h=Object.assign,Zh={};function os(n,e,t){this.props=n,this.context=e,this.refs=Zh,this.updater=t||Yh}os.prototype.isReactComponent={};os.prototype.setState=function(n,e){if(typeof n!="object"&&typeof n!="function"&&n!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,n,e,"setState")};os.prototype.forceUpdate=function(n){this.updater.enqueueForceUpdate(this,n,"forceUpdate")};function Kh(){}Kh.prototype=os.prototype;function vc(n,e,t){this.props=n,this.context=e,this.refs=Zh,this.updater=t||Yh}var _c=vc.prototype=new Kh;_c.constructor=vc;$h(_c,os.prototype);_c.isPureReactComponent=!0;var Mf=Array.isArray,Qh=Object.prototype.hasOwnProperty,xc={current:null},Jh={key:!0,ref:!0,__self:!0,__source:!0};function ep(n,e,t){var i,r={},s=null,o=null;if(e!=null)for(i in e.ref!==void 0&&(o=e.ref),e.key!==void 0&&(s=""+e.key),e)Qh.call(e,i)&&!Jh.hasOwnProperty(i)&&(r[i]=e[i]);var a=arguments.length-2;if(a===1)r.children=t;else if(1<a){for(var l=Array(a),u=0;u<a;u++)l[u]=arguments[u+2];r.children=l}if(n&&n.defaultProps)for(i in a=n.defaultProps,a)r[i]===void 0&&(r[i]=a[i]);return{$$typeof:ro,type:n,key:s,ref:o,props:r,_owner:xc.current}}function $g(n,e){return{$$typeof:ro,type:n.type,key:e,ref:n.ref,props:n.props,_owner:n._owner}}function yc(n){return typeof n=="object"&&n!==null&&n.$$typeof===ro}function Zg(n){var e={"=":"=0",":":"=2"};return"$"+n.replace(/[=:]/g,function(t){return e[t]})}var wf=/\/+/g;function ll(n,e){return typeof n=="object"&&n!==null&&n.key!=null?Zg(""+n.key):e.toString(36)}function ea(n,e,t,i,r){var s=typeof n;(s==="undefined"||s==="boolean")&&(n=null);var o=!1;if(n===null)o=!0;else switch(s){case"string":case"number":o=!0;break;case"object":switch(n.$$typeof){case ro:case Og:o=!0}}if(o)return o=n,r=r(o),n=i===""?"."+ll(o,0):i,Mf(r)?(t="",n!=null&&(t=n.replace(wf,"$&/")+"/"),ea(r,e,t,"",function(u){return u})):r!=null&&(yc(r)&&(r=$g(r,t+(!r.key||o&&o.key===r.key?"":(""+r.key).replace(wf,"$&/")+"/")+n)),e.push(r)),1;if(o=0,i=i===""?".":i+":",Mf(n))for(var a=0;a<n.length;a++){s=n[a];var l=i+ll(s,a);o+=ea(s,e,t,l,r)}else if(l=Yg(n),typeof l=="function")for(n=l.call(n),a=0;!(s=n.next()).done;)s=s.value,l=i+ll(s,a++),o+=ea(s,e,t,l,r);else if(s==="object")throw e=String(n),Error("Objects are not valid as a React child (found: "+(e==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":e)+"). If you meant to render a collection of children, use an array instead.");return o}function go(n,e,t){if(n==null)return n;var i=[],r=0;return ea(n,i,"","",function(s){return e.call(t,s,r++)}),i}function Kg(n){if(n._status===-1){var e=n._result;e=e(),e.then(function(t){(n._status===0||n._status===-1)&&(n._status=1,n._result=t)},function(t){(n._status===0||n._status===-1)&&(n._status=2,n._result=t)}),n._status===-1&&(n._status=0,n._result=e)}if(n._status===1)return n._result.default;throw n._result}var At={current:null},ta={transition:null},Qg={ReactCurrentDispatcher:At,ReactCurrentBatchConfig:ta,ReactCurrentOwner:xc};Ae.Children={map:go,forEach:function(n,e,t){go(n,function(){e.apply(this,arguments)},t)},count:function(n){var e=0;return go(n,function(){e++}),e},toArray:function(n){return go(n,function(e){return e})||[]},only:function(n){if(!yc(n))throw Error("React.Children.only expected to receive a single React element child.");return n}};Ae.Component=os;Ae.Fragment=Ug;Ae.Profiler=Vg;Ae.PureComponent=vc;Ae.StrictMode=Bg;Ae.Suspense=jg;Ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Qg;Ae.cloneElement=function(n,e,t){if(n==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+n+".");var i=$h({},n.props),r=n.key,s=n.ref,o=n._owner;if(e!=null){if(e.ref!==void 0&&(s=e.ref,o=xc.current),e.key!==void 0&&(r=""+e.key),n.type&&n.type.defaultProps)var a=n.type.defaultProps;for(l in e)Qh.call(e,l)&&!Jh.hasOwnProperty(l)&&(i[l]=e[l]===void 0&&a!==void 0?a[l]:e[l])}var l=arguments.length-2;if(l===1)i.children=t;else if(1<l){a=Array(l);for(var u=0;u<l;u++)a[u]=arguments[u+2];i.children=a}return{$$typeof:ro,type:n.type,key:r,ref:s,props:i,_owner:o}};Ae.createContext=function(n){return n={$$typeof:Hg,_currentValue:n,_currentValue2:n,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},n.Provider={$$typeof:Gg,_context:n},n.Consumer=n};Ae.createElement=ep;Ae.createFactory=function(n){var e=ep.bind(null,n);return e.type=n,e};Ae.createRef=function(){return{current:null}};Ae.forwardRef=function(n){return{$$typeof:Wg,render:n}};Ae.isValidElement=yc;Ae.lazy=function(n){return{$$typeof:qg,_payload:{_status:-1,_result:n},_init:Kg}};Ae.memo=function(n,e){return{$$typeof:Xg,type:n,compare:e===void 0?null:e}};Ae.startTransition=function(n){var e=ta.transition;ta.transition={};try{n()}finally{ta.transition=e}};Ae.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.")};Ae.useCallback=function(n,e){return At.current.useCallback(n,e)};Ae.useContext=function(n){return At.current.useContext(n)};Ae.useDebugValue=function(){};Ae.useDeferredValue=function(n){return At.current.useDeferredValue(n)};Ae.useEffect=function(n,e){return At.current.useEffect(n,e)};Ae.useId=function(){return At.current.useId()};Ae.useImperativeHandle=function(n,e,t){return At.current.useImperativeHandle(n,e,t)};Ae.useInsertionEffect=function(n,e){return At.current.useInsertionEffect(n,e)};Ae.useLayoutEffect=function(n,e){return At.current.useLayoutEffect(n,e)};Ae.useMemo=function(n,e){return At.current.useMemo(n,e)};Ae.useReducer=function(n,e,t){return At.current.useReducer(n,e,t)};Ae.useRef=function(n){return At.current.useRef(n)};Ae.useState=function(n){return At.current.useState(n)};Ae.useSyncExternalStore=function(n,e,t){return At.current.useSyncExternalStore(n,e,t)};Ae.useTransition=function(){return At.current.useTransition()};Ae.version="18.2.0";(function(n){n.exports=Ae})(io);const Jg=kg(io.exports);var pu={},tp={exports:{}},Xt={},np={exports:{}},ip={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function Eh(){return new nr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:vf(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function Th(){return new nr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vf(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function vf(){return`
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var iw=io.exports,rw=Symbol.for("react.element"),sw=Symbol.for("react.fragment"),ow=Object.prototype.hasOwnProperty,aw=iw.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,lw={key:!0,ref:!0,__self:!0,__source:!0};function Pg(n,e,t){var i,r={},s=null,o=null;t!==void 0&&(s=""+t),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)ow.call(e,i)&&!lw.hasOwnProperty(i)&&(r[i]=e[i]);if(n&&n.defaultProps)for(i in e=n.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:rw,type:n,key:s,ref:o,props:r,_owner:aw.current}}rl.Fragment=sw;rl.jsx=Pg;rl.jsxs=Pg;(function(n){n.exports=rl})(Lg);const Ua=Lg.exports.jsx;function uw(){io.exports.useEffect(()=>{const e=new $M,t=new Gt(50,window.innerWidth/window.innerHeight,1,1e3);t.position.z=96;const i=document.getElementById("myThreeJsCanvas"),r=new bg({canvas:i,antialias:!0});r.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(r.domElement);const s=new ew(16761035,.5);s.castShadow=!0,e.add(s);const o=new JM(16777215,1);o.castShadow=!0,o.position.set(0,64,32),e.add(o);const a=new _f(12,19.4,19.4),l=new ZM,u=new Wn(a,l);e.add(u);const c=new nw(t,r.domElement);new tw,new Me;const f=()=>{u.rotation.x+=.001,u.rotation.y+=.001,c.update(),r.render(e,t),window.requestAnimationFrame(f)};f()},[]),window.addEventListener("resize",n,!1);function n(){camera.aspect=window.innerWidth/window.innerHeight,camera.updateProjectionMatrix(),renderer.setSize(window.innerWidth,window.innerHeight),render()}return Ua("div",{children:Ua("canvas",{id:"myThreeJsCanvas"})})}pu.createRoot(document.getElementById("root")).render(Ua(Jg.StrictMode,{children:Ua(uw,{})}));
